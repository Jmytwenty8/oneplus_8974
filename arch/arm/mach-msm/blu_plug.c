...
/*
 * Dynamic Hotplug for mako / hammerhead / shamu / bacon
 *
 * Copyright (C) 2013 Stratos Karafotis <stratosk@semaphore.gr> (dyn_hotplug for mako)
 *
 * Copyright (C) 2015 engstk <eng.stk@sapo.pt> (hammerhea, bacon & shamu implementation, fixes and changes to blu_plug)
 *
